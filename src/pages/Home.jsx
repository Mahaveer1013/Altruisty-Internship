    ...
    return (
      <>
          <div className="host-part three">
            ...
            <Link to='/post-problem' className="important-button"> <span className="material-symbols-outlined">post_add</span>Post a problem</Link>
          </div>
        <div className="quote-part two">
        ...
        <div className="host-part five">
          ...
          <Link to='/hackathons' className="important-button"> <span className="material-symbols-outlined">visibility</span>View Problems</Link>
        </div>
          <div className="part one">
            <h3>About</h3>
